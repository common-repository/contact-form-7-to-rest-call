...
require_once('CF7RESTInstallIndicator.php');
...
class CF7RESTPluginLifeCycle extends CF7RESTInstallIndicator {
    ...
    protected function initOptions() {
         ...
         */
        $pluginDisplayName = "Contact Form 7 to REST service call";
